...
class ContextPath(nn.Module):
    def __init__(self, in_chans, pretrained=False, *args, **kwargs):
        super(ContextPath, self).__init__()
        self.resnet = timm.create_model('resnet18', in_chans=in_chans, features_only=True, output_stride=32,
...
class ABCNet(nn.Module):
    def __init__(self, n_classes, in_chans=3):
        super(ABCNet, self).__init__()
        self.name = 'ABCNet'
        self.aux = True
        self.n_classes = n_classes
        self.cp = ContextPath(in_chans)
        self.sp = SpatialPath()
