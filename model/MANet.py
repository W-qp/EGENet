...
class MANet(nn.Module):
    def __init__(self, n_classes, in_chans=3, backbone_name='resnet50', aux=False):
        super(MANet, self).__init__()
        self.name = 'MANet'
        self.aux = aux
        self.n_classes = n_classes

        self.backbone = timm.create_model(backbone_name, in_chans=in_chans, features_only=True, output_stride=32, out_indices=(1, 2, 3, 4))
